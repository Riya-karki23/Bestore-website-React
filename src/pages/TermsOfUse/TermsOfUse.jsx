    ...
    <>
      ...
      <section>
        <div className="termsOfUse-wrapper">
          <div className="termsOfUse-left-div">
            <h2>Content </h2>
          ...
          <div className="termsOfUse-right-div">
            {/* ----------------- */}
            <h3 className="right-div-heading">Terms and Conditions</h3>
            <h4>Welcome to Bethemestore!</h4>
            <p>
              These terms and conditions outline the rules and regulations for
              the use of Bethemestore's Website, located at Australia.</p>
               
              <p>By accessing this website we assume you accept these terms and
              conditions. Do not continue to use BeShop if you do not agree to
            ...
            <h3 className="right-div-heading">Cookies</h3>
            <p>
            We employ the use of cookies. By accessing Bethemestore, you agreed to use cookies in agreement with the Bethemestore's Privacy Policy.</p>
...
<p>Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.
            ...
            <h3 className="right-div-heading">Licence</h3>
...
<p>Bethemestore reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.
            </p>
            ...
            <p>You hereby grant Bethemestore a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>

            {/* -------- */}
            <h3 className="right-div-heading">Hyperlinking to our Content</h3>
...
<p>No use of Bethemestore's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>


{/* ----------------- */}
<h3 className="right-div-heading">iFrames</h3>
<p>Without prior approval and written permission, you may not create frames around our Webpages that alter in any way the visual presentation or appearance of our Website.</p>


{/* ----------------- */}
<h3 className="right-div-heading">Content Liability</h3>
<p>We shall not be hold responsible for any content that appears on your Website. You agree to protect and defend us against all claims that is rising on your Website. No link(s) should appear on any Website that may be interpreted as libelous, obscene or criminal, or which infringes, otherwise violates, or advocates the infringement or other violation of, any third party rights.</p>

{/* ---------------------- */}
<h3 className="right-div-heading">Reservation of Rights</h3>
